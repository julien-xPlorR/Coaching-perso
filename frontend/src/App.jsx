...
const FINE_CAT = {
  // Viandes & poissons
  "Filets de maquereau": "VIANDE", "Filet de poulet": "VIANDE", "Filet de daurade": "VIANDE", "Steak haché 5%": "VIANDE", "Sardines fraîches": "VIANDE", "Sardines à l'huile d'olive": "VIANDE",
  "Thon au naturel": "VIANDE", "Jambon blanc supérieur": "VIANDE", "Pavé de saumon": "VIANDE", "Poulet rôti (cuisse+blanc)": "VIANDE", "Filet de cabillaud": "VIANDE", "Filet de truite": "VIANDE",
  "Brochette de poulet": "VIANDE", "Brochette de boeuf": "VIANDE", "Pilon de poulet (sans peau)": "VIANDE", "Merguez": "VIANDE", "Chipolata": "VIANDE", "Araignée de porc": "VIANDE",
  "Escalope de dinde": "VIANDE", "Filet de dinde": "VIANDE", "Rôti de porc maigre": "VIANDE", "Filet mignon de porc": "VIANDE", "Rumsteck": "VIANDE", "Bavette": "VIANDE",
  "Faux-filet": "VIANDE", "Onglet de bœuf": "VIANDE", "Côtelette d'agneau": "VIANDE", "Gigot d'agneau": "VIANDE", "Lieu noir": "VIANDE", "Colin": "VIANDE",
  "Merlu": "VIANDE", "Bar (loup)": "VIANDE", "Rouget": "VIANDE", "Sole": "VIANDE", "Lotte": "VIANDE", "Espadon": "VIANDE",
  "Steak de thon frais": "VIANDE", "Saumon fumé": "VIANDE", "Truite fumée": "VIANDE", "Anchois frais": "VIANDE", "Crevettes": "VIANDE", "Moules": "VIANDE",
  "Calamars": "VIANDE", "Encornets": "VIANDE", "Poulpe": "VIANDE", "Noix de Saint-Jacques": "VIANDE", "Blanc de dinde tranché": "VIANDE", "Bresaola": "VIANDE",
  // Œufs & produits laitiers (vache)
  "Œufs": "LAIT", "Lait": "LAIT", "Fromage blanc de vache": "LAIT", "Skyr de vache": "LAIT", "Yaourt nature (vache)": "LAIT", "Mozzarella": "LAIT",
  "Feta": "LAIT", "Comté": "LAIT", "Parmesan": "LAIT", "Yaourt grec (vache)": "LAIT", "Yaourt à la grecque (vache)": "LAIT", "Ricotta (vache)": "LAIT",
  "Cottage cheese": "LAIT", "Petit-suisse": "LAIT", "Kéfir de lait": "LAIT", "Burrata (vache)": "LAIT", "Emmental": "LAIT", "Gruyère": "LAIT",
  "Cantal": "LAIT", "Beaufort": "LAIT", "Tomme de vache": "LAIT", "Gouda": "LAIT", "Edam": "LAIT", "Beurre doux": "LAIT",
  "Crème fraîche épaisse": "LAIT", "Crème liquide": "LAIT", "Grana Padano": "LAIT", "Fromage blanc battu 0%": "LAIT", "Mascarpone": "LAIT", "Bûche de chèvre": "LAIT", "Crottin de chèvre": "LAIT", "Chèvre frais": "LAIT", "Sainte-Maure de Touraine": "LAIT", "Rocamadour": "LAIT", "Roquefort": "LAIT", "Ossau-Iraty": "LAIT", "Pecorino": "LAIT", "Manchego": "LAIT", "Tomme de brebis": "LAIT", "Yaourt de brebis": "LAIT", "Feta de brebis": "LAIT",
  // Féculents & céréales
  "Flocons d'avoine": "CEREAL", "Flocons d'avoine fins": "CEREAL", "Quinoa": "CEREAL", "Riz complet": "CEREAL", "Riz blanc": "CEREAL", "Semoule complète": "CEREAL",
  "Boulgour": "CEREAL", "Pâtes complètes": "CEREAL", "Pâtes blanches": "CEREAL", "Boulgour cuit": "CEREAL", "Épeautre cuit": "CEREAL", "Riz basmati": "CEREAL",
  "Riz thaï": "CEREAL", "Riz sauvage": "CEREAL", "Riz rouge": "CEREAL", "Riz basmati cuit": "CEREAL", "Riz complet cuit": "CEREAL", "Quinoa cuit": "CEREAL",
  "Pâtes complètes cuites": "CEREAL", "Sarrasin": "CEREAL", "Flocons de sarrasin": "CEREAL", "Millet": "CEREAL", "Orge perlé": "CEREAL", "Petit épeautre": "CEREAL",
  "Épeautre (grain)": "CEREAL", "Blé précuit (Ebly)": "CEREAL", "Polenta (semoule de maïs)": "CEREAL", "Nouilles de riz": "CEREAL", "Nouilles soba": "CEREAL", "Muesli sans sucre ajouté": "CEREAL",
  "Flocons d'orge": "CEREAL", "Semoule de blé (couscous)": "CEREAL", "Pâtes semi-complètes": "CEREAL",
  ...
  "Épinards frais": "LEG", "Oignon": "LEG", "Avocat": "LEG", "Maïs doux": "LEG", "Frites de patate douce (four)": "LEG", "Brocolis": "LEG",
  "Blettes": "LEG", "Petits pois": "LEG", "Chou-fleur": "LEG", "Chou vert frisé (kale)": "LEG", "Chou vert": "LEG", "Chou rouge": "LEG",
  "Chou-rave": "LEG", "Chou chinois (pak choï)": "LEG", "Carotte": "LEG", "Betterave": "LEG", "Navet": "LEG", "Panais": "LEG",
  "Radis": "LEG", "Céleri branche": "LEG", "Céleri-rave": "LEG", "Poireau": "LEG", "Champignons de Paris": "LEG", "Cèpes": "LEG",
  "Girolles": "LEG", "Courgette jaune": "LEG", "Butternut": "LEG", "Potimarron": "LEG", "Potiron": "LEG", "Artichaut": "LEG",
  "Asperges vertes": "LEG", "Endive": "LEG", "Mâche": "LEG", "Cresson": "LEG", "Tomates cerises": "LEG", "Échalote": "LEG",
  "Fèves fraîches": "LEG", "Haricots beurre": "LEG",
  // Fruits frais
  "Fruits rouges": "FRUIT", "Citron": "FRUIT", "Banane": "FRUIT", "Pêche": "FRUIT", "Nectarine": "FRUIT", "Abricots": "FRUIT",
  "Melon": "FRUIT", "Figues": "FRUIT", "Poire": "FRUIT", "Pomme": "FRUIT", "Fraises": "FRUIT", "Framboises": "FRUIT",
  "Myrtilles": "FRUIT", "Mûres": "FRUIT", "Cassis": "FRUIT", "Cerises": "FRUIT", "Groseilles": "FRUIT", "Raisin frais": "FRUIT",
  "Prune": "FRUIT", "Mirabelle": "FRUIT", "Reine-claude": "FRUIT", "Orange": "FRUIT", "Clémentine": "FRUIT", "Mandarine": "FRUIT",
  "Pamplemousse": "FRUIT", "Kiwi": "FRUIT", "Pastèque": "FRUIT", "Ananas": "FRUIT", "Mangue": "FRUIT", "Papaye": "FRUIT",
  "Grenade": "FRUIT", "Kaki": "FRUIT", "Coing": "FRUIT", "Fruit de la passion": "FRUIT", "Citron vert": "FRUIT",
  // Herbes & épices
  "Basilic": "HERB", "Menthe": "HERB", "Persil": "HERB", "Coriandre": "HERB", "Ciboulette": "HERB", "Thym": "HERB",
  "Romarin": "HERB", "Origan": "HERB", "Aneth": "HERB", "Estragon": "HERB", "Sauge": "HERB", "Laurier": "HERB",
  "Cerfeuil": "HERB", "Gingembre frais": "HERB", "Curcuma": "HERB", "Cumin": "HERB", "Paprika": "HERB", "Piment d'Espelette": "HERB",
  "Curry": "HERB", "Cannelle": "HERB", "Ras el hanout": "HERB", "Herbes de Provence": "HERB", "Poivre noir": "HERB", "Sel": "HERB",
  "Noix de muscade": "HERB",
  // Boulangerie
  "Pain complet au levain": "BOUL", "Galette complète (blé)": "BOUL", "Pain blanc / baguette": "BOUL", "Pain d'épices": "BOUL", "Pain de seigle": "BOUL", "Pain aux céréales": "BOUL",
  "Pain complet": "BOUL", "Pain de campagne": "BOUL", "Pain suédois (Wasa)": "BOUL", "Pita complète": "BOUL", "Tortilla complète (wrap)": "BOUL", "Biscottes complètes": "BOUL",
  "Pain de mie complet": "BOUL", "Pain aux noix": "BOUL",
  // Épicerie, oléagineux & conserves
  "Cerneaux de noix": "EPI", "Graines de chia": "EPI", "Graines de lin": "EPI", "Miel": "EPI", "Huile d'olive": "EPI", "Amandes": "EPI",
  "Beurre de cacahuète": "EPI", "Noisettes": "EPI", "Olives noires": "EPI", "Lait de coco": "EPI", "Houmous": "EPI", "Beurre d'amande": "EPI",
  "Tomates concassées": "EPI", "Confiture d'abricot": "EPI", "Compote sans sucres ajoutés": "EPI", "Jus d'orange pressé": "EPI", "Raisins secs": "EPI", "Abricots secs": "EPI",
  "Dattes": "EPI", "Boisson glucidique (poudre)": "EPI", "Gel énergétique": "EPI", "Barre céréalière": "EPI", "Cola": "EPI", "Noix de cajou": "EPI",
